...
extern SpatialPartitionCell gStaticSurfacePartition[NUM_CELLS][NUM_CELLS][NUM_CELLS];
extern SpatialPartitionCell gDynamicSurfacePartition[NUM_CELLS][NUM_CELLS][NUM_CELLS];
